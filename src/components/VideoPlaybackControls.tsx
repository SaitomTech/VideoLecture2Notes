...
export function VideoPlayButton({ isPlaying, onToggle, disabled = false }: VideoPlayButtonProps) {
  return (
    <button
...
export function VideoPlaybackControls({
  ...
  return (
    <div className="mt-3 flex flex-wrap items-center gap-3 rounded-[10px] border border-[#d8e1dc] bg-[#f4f7f4] px-3.5 py-3">
      <VideoPlayButton isPlaying={isPlaying} onToggle={onToggle} disabled={safeDuration === 0} />
