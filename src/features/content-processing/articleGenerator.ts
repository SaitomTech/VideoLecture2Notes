...
const ARTICLE_PROMPT = [
  ...
  '</ARTICLE BODY>',
  '<BAD ARTICLE BODY>',
  '本発表は、@_yasaichiさんによる「Active Recordから考える 次の10年を見据えた技術選定」という発表へのアンサー発表です。その発表を参考にしながら進めていきます。',
  '</BAD ARTICLE BODY>',
  'このBAD ARTICLE BODYは、「素晴らしい」という評価や、アンサー発表の存在についての発話を削って短く要約しているため不正解です。',
  '',
  '例2——OCRにしかない情報を追加しない:',
  '<RAW TRANSCRIPT>',
