import { AlertTriangle, Check, Mic2, RefreshCw, Square } from 'lucide-react'
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            <h2
              id="transcription-status-heading"
              className="text-[13px] font-semibold text-[#18211f]"
            >
              処理状況
            </h2>
            <span
      ...
      <div
        ...
        aria-label={isRunning ? stageLabels[stage] : '文字起こしの進捗'}
      >
