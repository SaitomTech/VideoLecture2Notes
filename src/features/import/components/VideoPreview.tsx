...
export function VideoPreview({ video, videoStatus, isDragging, isSelecting, onChoose, onVideoReady, onVideoError }: VideoPreviewProps) {
  return (
    <div className={`overflow-hidden rounded-[18px] border bg-[#14231d] shadow-[0_18px_52px_rgba(22,54,42,0.07)] transition-[border-color,box-shadow] duration-200 ${videoStatus === 'error' ? 'border-[#b6533a]' : isDragging ? 'border-[#1d6b50] shadow-[0_22px_70px_rgba(22,54,42,0.14)]' : 'border-[#b7cbc0]'}`}>
